...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        # Set up the player
        self.player_sprite = arcade.Sprite("hat-guy.png", SPRITE_SCALING)
        ...
        for row_index, row in enumerate(map_array):
            for column_index, item in enumerate(row):
                ...
                if item == -1:
                    ...
                    wall = arcade.Sprite("platformer/Tiles/box.png", SPRITE_SCALING)
                elif item == 1:
                    wall = arcade.Sprite("platformer/Tiles/grassLeft.png", SPRITE_SCALING)
                elif item == 2:
                    wall = arcade.Sprite("platformer/Tiles/grassMid.png", SPRITE_SCALING)
                elif item == 3:
                    wall = arcade.Sprite("platformer/Tiles/grassRight.png", SPRITE_SCALING)
